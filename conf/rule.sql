...
INSERT INTO alert_contacts (id, realm_name, name, type, enabled, details)
VALUES
    (1, 'master', 'Admin Email', 'email', 1, '{"email": "admin@example.com"}'),
    (2, 'master', 'Line Channel', 'line', 1, '{"webhook_url": "https://notify-bot.line.me/","user_id": "cmt3Ss2pIjnXr7mARzOSwdB04t89/1O/w1cDnyilFU=","token": "s9Bao6VivhqM1u6Tap1fBSvIkDXVqbxks9nZG4BAdrifTl4TdGDwBhZXSN/G+EDRAktX+REGJsUXFVeZZsiIOJ8GrhnR2U0QRBwZaRBjThZkRJtTD5/2EQOxCyFpjdFB"}');
